...
3. Escolha o arquivo [`database/wellness.sql`](database/wellness.sql) deste projeto
...
- O arquivo `database/wellness.sql` guarda apenas a **estrutura** do banco (sem dados de usuários). Cada pessoa cria seus próprios cadastros localmente.
